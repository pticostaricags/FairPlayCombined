BEGIN TRANSACTION
--START OF ENABLING FULL-TEXT INDEXES
ALTER FULLTEXT INDEX ON [FairPlayTube].[VideoInfo] ENABLE;
ALTER FULLTEXT INDEX ON [FairPlayTube].[VideoInfo] START FULL POPULATION;
-- END OF ENABLING FULL-TEXT INDEXES
