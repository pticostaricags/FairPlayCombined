...
namespace FairPlayCombined.Migrations
{
    public static class SharedMigrations
    {
        ...
        public static void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId = table.Column<string>(type: NVarchar_450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: NVarchar_450, nullable: false),
                    ClaimType = table.Column<string>(type: NVarchar_Max, nullable: true),
                    ClaimValue = table.Column<string>(type: NVarchar_Max, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoginProvider = table.Column<string>(type: NVarchar_450, nullable: false),
                    ProviderKey = table.Column<string>(type: NVarchar_450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: NVarchar_450, nullable: false),
                    LoginProvider = table.Column<string>(type: NVarchar_450, nullable: false),
                    Name = table.Column<string>(type: NVarchar_450, nullable: false),
