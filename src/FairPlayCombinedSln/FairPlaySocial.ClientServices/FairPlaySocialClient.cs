...
//----------------------
// <auto-generated>
//     Generated REST API Client Code Generator v1.8.10.0 on 11/25/2023 7:06:11 PM
...
using FairPlaySocial.ClientServices.Api.Photos;
using FairPlaySocial.ClientServices.Api.Photos.CreatePhoto;
using FairPlaySocial.ClientServices.Api.Posts;
using FairPlaySocial.ClientServices.Api.Posts.CreatePost;
using FairPlaySocial.ClientServices.Api.Posts.GetPaginatedPosts;
...
// <auto-generated/>
namespace FairPlaySocial.ClientServices.Models {
    public class CreatePhotoModel : IParsable {
...
#nullable restore
        ...
        public string Name { get; set; }
#endif
        /// <summary>The photoBytes property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CreatePhotoModel CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"photoBytes", n => { PhotoBytes = n.GetStringValue(); } },
            };
        }
        /// <summary>
        /// Serializes information the current object
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteStringValue("photoBytes", PhotoBytes);
        }
    }
}
...
// <auto-generated/>
namespace FairPlaySocial.ClientServices.Models {
    public class PostModel : IParsable {
        /// <summary>The groupId property</summary>
        public long? GroupId { get; set; }
        /// <summary>The ownerApplicationUserId property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
...
#nullable restore
        ...
        public string OwnerApplicationUserId { get; set; }
#endif
        /// <summary>The ownerApplicationUserName property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PostModel CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"groupId", n => { GroupId = n.GetLongValue(); } },
                {"ownerApplicationUserId", n => { OwnerApplicationUserId = n.GetStringValue(); } },
                {"ownerApplicationUserName", n => { OwnerApplicationUserName = n.GetStringValue(); } },
                {"photoId", n => { PhotoId = n.GetLongValue(); } },
                {"postId", n => { PostId = n.GetLongValue(); } },
                {"postTypeId", n => { PostTypeId = n.GetIntValue(); } },
                {"postVisibilityId", n => { PostVisibilityId = n.GetIntValue(); } },
                {"replyToPostId", n => { ReplyToPostId = n.GetLongValue(); } },
                {"text", n => { Text = n.GetStringValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteLongValue("groupId", GroupId);
            writer.WriteStringValue("ownerApplicationUserId", OwnerApplicationUserId);
            writer.WriteStringValue("ownerApplicationUserName", OwnerApplicationUserName);
            writer.WriteLongValue("photoId", PhotoId);
            writer.WriteLongValue("postId", PostId);
            writer.WriteIntValue("postTypeId", PostTypeId);
            writer.WriteIntValue("postVisibilityId", PostVisibilityId);
            writer.WriteLongValue("replyToPostId", ReplyToPostId);
            writer.WriteStringValue("text", Text);
...
// <auto-generated/>
namespace FairPlaySocial.ClientServices.Models {
    public class PostModelPaginationOfT : IParsable {
...
#nullable restore
        ...
        /// </summary>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PostModelPaginationOfT CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PostModelPaginationOfT();
        }
        /// <summary>
        /// The deserialization information for the current model
        /// </summary>
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"items", n => { Items = n.GetCollectionOfObjectValues<PostModel>(PostModel.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            _ = writer ?? throw new ArgumentNullException(nameof(writer));
            writer.WriteCollectionOfObjectValues<PostModel>("items", Items);
...
// <auto-generated/>
namespace FairPlaySocial.ClientServices.Api.Photos {
    /// <summary>
    /// Builds and executes requests for operations under \api\photos
    /// </summary>
    public class PhotosRequestBuilder : BaseRequestBuilder {
        /// <summary>The createPhoto property</summary>
        public CreatePhotoRequestBuilder CreatePhoto { get =>
            new CreatePhotoRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        ...
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PhotosRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/photos", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PhotosRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PhotosRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/photos", rawUrl) {
        }
    }
}
...
namespace FairPlaySocial.ClientServices.Api.Posts {
    ...
    public class PostsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>The GetPaginatedPosts property</summary>
        public GetPaginatedPostsRequestBuilder GetPaginatedPosts { get =>
            new GetPaginatedPostsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
// <auto-generated/>
namespace FairPlaySocial.ClientServices.Api.Photos.CreatePhoto {
    /// <summary>
    /// Builds and executes requests for operations under \api\photos\createPhoto
    /// </summary>
    public class CreatePhotoRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new CreatePhotoRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreatePhotoRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/photos/createPhoto", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreatePhotoRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreatePhotoRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/photos/createPhoto", rawUrl) {
        }
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<long?> PostAsync(CreatePhotoModel body, Action<CreatePhotoRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<long?> PostAsync(CreatePhotoModel body, Action<CreatePhotoRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(CreatePhotoModel body, Action<CreatePhotoRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(CreatePhotoModel body, Action<CreatePhotoRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new CreatePhotoRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
        ...
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public CreatePhotoRequestBuilder WithUrl(string rawUrl) {
            return new CreatePhotoRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        public class CreatePhotoRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new createPhotoRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public CreatePhotoRequestBuilderPostRequestConfiguration() {
                Options = new List<IRequestOption>();
                Headers = new RequestHeaders();
            }
        }
...
// <auto-generated/>
namespace FairPlaySocial.ClientServices.Api.Posts.GetPaginatedPosts {
    /// <summary>
    /// Builds and executes requests for operations under \api\posts\GetPaginatedPosts
    /// </summary>
    public class GetPaginatedPostsRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new GetPaginatedPostsRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetPaginatedPostsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/posts/GetPaginatedPosts{?startIndex*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetPaginatedPostsRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetPaginatedPostsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/posts/GetPaginatedPosts{?startIndex*}", rawUrl) {
        }
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<PostModelPaginationOfT?> GetAsync(Action<GetPaginatedPostsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<PostModelPaginationOfT> GetAsync(Action<GetPaginatedPostsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<PostModelPaginationOfT>(requestInfo, PostModelPaginationOfT.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<GetPaginatedPostsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<GetPaginatedPostsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new GetPaginatedPostsRequestBuilderGetRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
        ...
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetPaginatedPostsRequestBuilder WithUrl(string rawUrl) {
            return new GetPaginatedPostsRequestBuilder(rawUrl, RequestAdapter);
        }
        public class GetPaginatedPostsRequestBuilderGetQueryParameters {
        ...
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        public class GetPaginatedPostsRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public GetPaginatedPostsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new GetPaginatedPostsRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new GetPaginatedPostsRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public GetPaginatedPostsRequestBuilderGetRequestConfiguration() {
                Options = new List<IRequestOption>();
                Headers = new RequestHeaders();
            }
        }
